...
async def seed_data(
    ...
    """
    logger.info("Сидирование: старт заполнения тестовых данных")
    ...
    try:
        ...
        logger.exception("Сидирование: ошибка базы данных")
        raise
    except (ValueError, TypeError, KeyError):
        logger.exception("Сидирование: ошибка подготовки тестовых данных")
        raise
