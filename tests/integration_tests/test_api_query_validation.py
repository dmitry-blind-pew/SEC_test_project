...
async def test_radius_query_validation_422(api_client: AsyncClient, params: dict) -> None:
...
async def test_radius_lon_lat_validation_422(api_client: AsyncClient, params: dict) -> None:
