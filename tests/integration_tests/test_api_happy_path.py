...
async def test_ok_with_valid_api_key(api_client: AsyncClient, path: str, params: dict) -> None:
    """Проверяет, что защищенные GET-роуты отвечают 200 при валидном API-ключе."""
